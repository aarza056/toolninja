...
btoa('你好');        // THROWS — CJK characters above U+00FF
```
...
const encoded = base64Encode('Hello 👋 你好 €100');
const decoded = base64Decode(encoded);  // 'Hello 👋 你好 €100'
```
...
| Latin-1 text (é, ñ) | Yes (codes ≤255) | Use directly |
